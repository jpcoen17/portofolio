              ...
              <div className="col col-6 border-line-v">
                <div className="text-box"  data-aos="fade-up">
                  <p>
                    ...
                    I am a crypto enthusiast with over 7 years of experience in the Web3 space, specializing in community management, moderation, and user support. I enjoy helping users understand blockchain products, solving problems, and keeping communities active and engaged. I have worked with various crypto projects as a moderator, collaboration manager, and ambassador, which has helped me build strong communication and teamwork skills. I’m always eager to learn, adapt to new trends, and contribute to the growth of the crypto ecosystem.
                  </p>
                </div>
              </div>
              <div className="col col-6 border-line-v">
