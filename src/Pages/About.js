            ...
            <div className="row">
              <div className="col col-6 border-line-v">
                <div className="text-box"  data-aos="fade-up">
                  <p>
                    <b>I'm</b>{" "} {new Date().getFullYear() <=2024 ? ` a ${new Date().getFullYear() - 2020}${new Date().getFullYear() < 4 ? "th" : "rd" } year B.tech student pursuing ` : ""}
                    a crypto enthusiast with over 7 years of experience in the Web3 space, specializing in community management, moderation, and user support. I enjoy helping users understand blockchain products, solving problems, and keeping communities active and engaged. I have worked with various crypto projects as a moderator, collaboration manager, and ambassador, which has helped me build strong communication and teamwork skills. I’m always eager to learn, adapt to new trends, and contribute to the growth of the crypto ecosystem.
                  </p>
                </div>
              </div>
              <div className="col col-6 border-line-v">
                <div className="info-list"  data-aos="fade-up">
                  <ul>
                    ...
                    <li>
                      <strong>Birthday: </strong>17 Desember 2001
                    </li>
                    <li>
                      <strong>Hometown: </strong>Bojonegoro, Indonesia
                    </li>
                    <li>
                      <strong>Gmail: </strong>muhammadiklil520@gmail.com
                    </li>
                    <li>
                      <strong>Residence: </strong>Bojonegoro, Indonesia
                    </li>
                  </ul>
                </div>
              </div>
